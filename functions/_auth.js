...
async function sendEmail(ctx, to, subject, html) {
  ...
  const from =
    ctx.env.AUTH_FROM_EMAIL ||
    'YoqArt <noreply@yoqart.in>';
...
<p>${text}</p>
<p>
<a href="${url}" style="display:inline-block;background:#6955e8;color:white;padding:12px 18px;border-radius:10px;text-decoration:none;font-weight:700">
${buttonText}
</a>
</p>
<p style="color:#68738a;font-size:12px">
